module github.com/edreed/azure-permissions-checker
...
replace sigs.k8s.io/cloud-provider-azure => github.com/edreed/cloud-provider-azure v0.0.0-20220105174156-dd368ed8c1eb
